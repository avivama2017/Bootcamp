...
public class CommonAPI {
    ...
    public static WebDriver getLocalDriver(String browser, String platform) {
        if (platform.equalsIgnoreCase("mac") && browser.equalsIgnoreCase("chrome")) {
            System.setProperty("webdriver.chrome.driver", "/Users/mdriad/Downloads/BootCamp/generic/drivers/chromedriver 75");
    ...
    public static void getScreenshot(WebDriver driver) {
        ...
        File file = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
        try {
            FileUtils.copyFile(file, new File("/Users/mdriad/Downloads/BootCamp/Amazon/screenshot"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
